...
function copyFile(source, target, cb) {
  ...
  write.on("close", () => {
    console.log(file, 'boilerplate generated at ', process.cwd() + '/'+ file)
    done();
  });
...
module.exports = makeCopy(copyFile, [`${path.resolve(__dirname, './template.test.js')}`, `./${file}.test.js`, console.log], () => console.log('DONE'))